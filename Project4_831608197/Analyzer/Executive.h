...
*  - first release
*
*/ //ver 1.3: enhanced to make it Repostory//
...
namespace CodeAnalysis
{
  ...
  ///////////////////////////////////////////////////////////////////
  // Client Hanlder class is used to make the Repository capable of recieving messages and processing them.
  class ClientHandler
  {
  public:
	  using Path = std::string;
  ...
  public:
	  ...
	  HttpMessage frameMessageForPost(HttpMessage& msg, Socket& socket);
  private:
	  bool connectionClosed_;
	  HttpMessage frameMessage(Socket& socket);
  ...
  public:
	...
	static DependMap dependencyMapForUse;
  private:
